...
IncrementScore:
	...
	# This part of the code decides whether to display either 5 or 0 /00(0)/
...
PrintZero:	
	...
	li 	$t1, 11				# load coords (11, 0) 00(0)
	li 	$t2, 0
...
AddTens:
	...
	li	$t1, 10				# load coords (10, 0) 0(0)0
	li	$t2, 0
...
printHundreds:	
	...
	li 	$t1, 9				# load coords (9, 0) for (0)00
	li 	$t2, 0
